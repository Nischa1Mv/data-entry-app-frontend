  ...
  return (
    <SafeAreaView className="flex-1 bg-white gap-2">
      ...
      <View className="flex-row justify-between items-center px-6 pt-10 pb-4">
        <View>
          <Text className="font-inter font-semibold text-lg leading-8 tracking-[-0.006em]">{t('welcome.title') || 'Welcome back!'}</Text>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 30 }}>
        <View className="flex-row flex-wrap justify-center">
          {['ERP 1', 'ERP 2', 'ERP 3', 'ERP 4', 'ERP 5', 'ERP 6'].map((label, i) => (
            <TouchableOpacity
              key={i}
